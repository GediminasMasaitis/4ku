...
const i32 max_material[] = {126, 395, 401, 738, 1421, 0, 0};
const i32 material[] = {S(106, 126), S(354, 395), S(364, 401), S(491, 738), S(963, 1421), 0};
const i32 pst_rank[][8] = {
    {0, S(-3, 0), S(-3, -1), S(-1, -1), S(1, 0), S(5, 2), 0, 0},
    {S(-4, -4), S(-2, -2), S(-1, -1), S(1, 3), S(4, 3), S(8, 1), S(5, 0), S(-11, 0)},
    {S(-2, -1), S(1, -1), S(1, 0), S(1, 0), S(2, 1), S(4, 0), S(1, 0), S(-8, 2)},
    {S(-2, -3), S(-3, -3), S(-4, -2), S(-4, 1), S(-1, 2), S(3, 2), S(4, 2), S(6, 1)},
    {S(1, -11), S(1, -9), S(0, -4), S(-2, 2), S(-2, 6), S(1, 5), S(-2, 8), S(2, 5)},
    {S(0, -5), S(0, -1), S(-2, 0), S(-4, 2), S(0, 3), S(8, 2), S(6, 1), S(3, -4)},
};
const i32 pst_file[][8] = {
    {S(-2, 0), S(-1, 1), S(-1, 0), S(0, -1), S(1, 0), S(2, 0), S(2, 0), S(-2, 0)},
    {S(-5, -2), S(-2, -1), S(0, 2), S(2, 3), S(2, 2), S(2, 0), S(1, -1), S(-1, -3)},
    {S(-2, 0), 0, S(1, 0), S(0, 1), S(0, 1), S(-1, 1), S(2, 0), S(0, -1)},
    {S(-2, 0), S(-2, 1), S(0, 1), S(1, 0), S(1, -1), S(1, 0), S(2, 0), S(-1, -1)},
    {S(-3, -4), S(-2, -3), S(-1, -1), S(0, 1), S(0, 2), S(1, 3), S(3, 1), S(3, 1)},
    {S(-3, -4), S(2, -2), S(-2, 1), S(-4, 2), S(-4, 2), S(-2, 1), S(2, -1), S(0, -4)},
};
const i32 open_files[][5] = {
    {S(3, 2), S(-3, 17), S(22, 15), S(4, 17), S(-21, 8)},
    {S(-2, -12), S(-9, -2), S(51, -1), S(-10, 27), S(-63, 0)},
};
const i32 mobilities[] = {S(8, 4), S(8, 6), S(4, 4), S(4, 3), S(-4, -1)};
const i32 pawn_protection[] = {S(25, 13), S(2, 16), S(9, 16), S(10, 8), S(-7, 22), S(-39, 22)};
const i32 passers[] = {S(-3, 12), S(25, 43), S(59, 108), S(205, 191)};
const i32 pawn_passed_protected = S(13, 18);
const i32 pawn_doubled = S(-16, -33);
const i32 pawn_phalanx = S(13, 12);
const i32 pawn_passed_blocked[] = {S(-9, -13), S(6, -37), S(5, -76), S(6, -103)};
const i32 pawn_passed_king_distance[] = {S(1, -6), S(-4, 10)};
