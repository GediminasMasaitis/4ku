...
const i32 max_material[] = {138, 438, 440, 830, 1646, 0, 0};
const i32 material[] = {S(95, 138), S(343, 438), S(352, 440), S(468, 830), S(849, 1646), 0};
const i32 pst_rank[] = {
...
const i32 pst_file[] = {
    ...
    S(-3, -5), S(2, -2),  S(-1, 1), S(-2, 1), S(-3, 2), S(-1, 1), S(2, -1), S(0, -5)    // King
};
...
const i32 king_attacks[] = {S(11, -5), S(19, -5), S(27, -10), S(21, 2), 0};
const i32 pawn_protection[] = {S(22, 13), S(2, 15), S(6, 17), S(8, 10), S(-5, 19), S(-31, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 1), S(12, 5), S(11, 17), S(9, 17), S(6, 5)};
const i32 passers[] = {S(3, 13), S(32, 49), S(62, 123), S(198, 249)};
const i32 pawn_passed_protected = S(10, 19);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(12, 11);
const i32 pawn_passed_blocked_penalty[] = {S(9, 13), S(-6, 41), S(-8, 83), S(-10, 159)};
