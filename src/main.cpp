...
const i32 max_material[] = {138, 432, 436, 821, 1656, 0, 0};
const i32 material[] = {S(95, 138), S(335, 432), S(344, 436), S(459, 821), S(791, 1656), 0};
const i32 pst_rank[] = {
    ...
    S(0, -5),  S(0, -2),  0,         S(-2, 2),  S(1, 4),  S(6, 4), S(3, 3),  S(1, -3)    // King
};
const i32 pst_file[] = {
    ...
    S(-4, -4), S(1, -1),  S(-3, 1), S(-3, 2), S(3, 0),  S(-2, 1), 0,       S(-2, -4)   // King
};
...
const i32 king_attacks[] = {S(11, -5), S(20, -5), S(27, -10), S(21, 4), 0};
const i32 pawn_protection[] = {S(23, 14), S(2, 14), S(6, 17), S(8, 10), S(-5, 19), S(-34, 26)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 1), S(12, 5), S(10, 18), S(9, 16), S(5, 5)};
const i32 passers[] = {S(2, 13), S(30, 49), S(59, 122), S(192, 248)};
const i32 pawn_passed_protected = S(10, 19);
const i32 pawn_doubled_penalty = S(11, 37);
const i32 pawn_phalanx = S(13, 12);
const i32 pawn_passed_blocked_penalty[] = {S(10, 12), S(-6, 40), S(-7, 81), S(-9, 157)};
const i32 pawn_passed_king_distance[] = {S(1, -6), S(-4, 11)};
const i32 bishop_pair = S(32, 72);
const i32 king_shield[] = {S(38, 2), S(33, -12), S(25, -15), S(27, -2)};
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    if (p == King && piece_bb & 0xC3D7) {
                        ...
                        score += count(shield & pawns[0]) * king_shield[!rank];
                        score += count(north(shield) & pawns[0]) * king_shield[2 + !rank];
                    }
                }
            }
        }
