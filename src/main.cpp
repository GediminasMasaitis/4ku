...
const i32 max_material[] = {124, 408, 442, 768, 1471, 0, 0};
const i32 material[] = {S(107, 124), S(377, 408), S(391, 442), S(492, 768), S(974, 1471), 0};
const i32 pst_rank[][8] = {
    {0, S(-3, 0), S(-3, -1), S(-1, -1), S(2, 0), S(5, 2), 0, 0},
    {S(-6, -5), S(-4, -1), S(-1, 0), S(1, 3), S(5, 4), S(10, 1), S(6, -1), S(-11, -1)},
    {S(-5, -2), S(-1, -1), S(1, 0), S(2, 2), S(3, 2), S(6, 0), S(2, 0), S(-8, 0)},
...
const i32 pawn_protection[] = {S(26, 14), S(5, 16), S(2, 8), S(9, 5), S(-9, 12), S(-35, 23)};
const i32 passers[] = {S(-9, 15), S(15, 45), S(47, 108), S(198, 195)};
const i32 pawn_passed_protected = S(16, 18);
const i32 pawn_doubled = S(-16, -31);
const i32 pawn_phalanx = S(12, 13);
const i32 pawn_passed_blocked[] = {S(-8, -19), S(9, -42), S(10, -79), S(20, -102)};
