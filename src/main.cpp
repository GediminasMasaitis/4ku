...
const i32 max_material[] = {142, 443, 435, 828, 1647, 0, 0};
const i32 material[] = {S(93, 142), S(340, 443), S(354, 435), S(469, 828), S(853, 1647), 0};
const i32 pst_rank[] = {
    ...
    S(2, -12), S(2, -9),  S(1, -4),  S(0, 1),   S(-1, 5), S(0, 5), S(-3, 7), S(-1, 6),   // Queen
    S(-1, -5), S(1, -2),  0,         S(-2, 2),  S(0, 4),  S(6, 4), S(3, 3),  S(1, -4)    // King
};
const i32 pst_file[] = {
    ...
    S(-3, -5), S(3, -2),  S(-1, 1), S(-2, 1), S(-3, 2), S(-1, 1), S(2, -1), S(-1, -5)   // King
};
...
const i32 unprotected_pawn_attacks[] = {S(-13, 23), S(-3, 23), S(-3, 18), S(-5, 3), 0};
const i32 pawn_protection[] = {S(25, 9), S(2, 13), S(6, 19), S(8, 8), S(-5, 18), S(-30, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 2), S(16, 8), S(12, 3), S(12, 13), S(11, 15), S(6, 5)};
const i32 passers[] = {S(6, 12), S(37, 47), S(69, 119), S(206, 246)};
const i32 pawn_passed_protected = S(10, 19);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(13, 10);
const i32 pawn_passed_blocked_penalty[] = {S(10, 12), S(-5, 40), S(-7, 81), S(-9, 155)};
