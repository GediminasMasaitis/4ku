...
const i32 max_material[] = {138, 433, 435, 821, 1651, 0, 0};
const i32 material[] = {S(94, 138), S(335, 433), S(344, 435), S(457, 821), S(795, 1651), 0};
const i32 pst_rank[] = {
...
const i32 king_attacks[] = {S(11, -5), S(19, -5), S(27, -10), S(21, 4), 0};
const i32 pawn_protection[] = {S(22, 14), S(2, 15), S(6, 17), S(8, 10), S(-5, 19), S(-32, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 1), S(12, 5), S(11, 17), S(10, 17), S(6, 5)};
const i32 passers[] = {S(1, 14), S(29, 50), S(57, 124), S(191, 249)};
const i32 pawn_passed_protected = S(10, 18);
const i32 pawn_doubled_penalty = S(11, 37);
const i32 pawn_phalanx = S(12, 14);
const i32 pawn_passed_blocked_penalty[] = {S(9, 12), S(-6, 40), S(-8, 82), S(-8, 155)};
const i32 pawn_passed_king_distance[] = {S(1, -6), S(-4, 11)};
const i32 bishop_pair = S(32, 72);
const i32 king_shield[] = {S(34, 2), S(37, -16), S(19, -13), S(29, -4)};
