...
const i32 material[] = {S(93, 136), S(325, 443), S(334, 446), S(439, 837), S(743, 1697), 0};
const i32 pst_rank[] = {
    ...
    S(-1, -5), S(1, -2),  0,         S(-2, 2),  S(0, 4),  S(5, 4), S(2, 3),  S(1, -4)    // King
};
const i32 pst_file[] = {
...
const i32 king_attacks[] = {S(10, -4), S(19, -5), S(27, -9), S(21, 5), S(-2, 3)};
const i32 pawn_protection[] = {S(22, 14), S(2, 14), S(6, 17), S(8, 9), S(-5, 19), S(-30, 24)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 2), S(11, 6), S(10, 17), S(9, 16), S(4, 6)};
const i32 passers[] = {S(3, 14), S(33, 50), S(62, 124), S(194, 255)};
