...
const i32 max_material[] = {141, 440, 442, 832, 1648, 0, 0};
const i32 material[] = {S(94, 141), S(343, 440), S(351, 442), S(467, 832), S(850, 1648), 0};
const i32 pst_rank[] = {
    ...
    S(-1, -5), S(1, -1),  0,         S(-2, 2),  S(0, 3),  S(6, 3), S(3, 2),  S(1, -4)    // King
};
const i32 pst_file[] = {
    ...
    S(-3, -5), S(3, -2),  S(-1, 1), S(-2, 2), S(-3, 2), S(-1, 1), S(2, -1), S(-1, -4)   // King
};
...
const i32 king_attacks[] = {S(11, -5), S(19, -4), S(27, -10), S(21, 3), 0};
const i32 pawn_protection[] = {S(23, 13), S(2, 15), S(6, 17), S(8, 9), S(-5, 19), S(-29, 21)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 1), S(12, 5), S(11, 17), S(9, 17), S(8, 1)};
const i32 passers[] = {S(0, 21), S(27, 61), S(55, 139), S(191, 267)};
const i32 pawn_passed_protected = S(12, 14);
const i32 pawn_doubled_penalty = S(10, 38);
const i32 pawn_phalanx = S(12, 10);
const i32 pawn_passed_blocked_penalty[] = {S(12, 6), S(-4, 34), S(-7, 76), S(-12, 154)};
const i32 pawn_passed_king_distance[] = {S(1, -7), S(-4, 10)};
const i32 bishop_pair = S(32, 72);
const i32 king_pawn_attack = S(19, 35);
        ...
        for (i32 p = 0; p < 6; ++p) {
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    // King attacking unprotected pawn
                    if (p == King && king(sq, 0) & pawns[1] & ~attacked_by_pawns)
                        score += king_pawn_attack;
