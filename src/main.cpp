...
const i32 max_material[] = {139, 438, 440, 831, 1648, 0, 0};
const i32 material[] = {S(95, 139), S(344, 438), S(352, 440), S(465, 831), S(847, 1648), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 2), 0,        0,          // Pawn
    S(-2, -4), S(-1, -3), S(0, -1),  S(2, 2),   S(3, 4),  S(6, 1), S(4, 0),  S(-12, 1),  // Knight
    S(-1, -1), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 1),  S(3, 0), 0,        S(-9, 2),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-3, 0),  S(0, 2),  S(2, 2), S(1, 3),  S(2, 1),    // Rook
    S(3, -11), S(3, -9),  S(1, -4),  S(0, 1),   S(-1, 5), S(0, 5), S(-3, 7), S(-1, 5),   // Queen
    S(-1, -6), S(1, -1),  0,         S(-3, 2),  S(-1, 4), S(5, 4), S(3, 3),  S(1, -4)    // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0), S(-1, -1),  // Pawn
    S(-5, -3), S(-2, -1), S(0, 1),  S(2, 3),  S(2, 2),  S(2, 1),  S(1, 0), S(-1, -3),  // Knight
    ...
    S(-3, -5), S(2, -1),  S(-2, 1), S(-3, 2), S(-4, 2), S(-1, 1), S(2, 0), S(-1, -5)   // King
};
...
const i32 mobilities[] = {S(9, 5), S(8, 7), S(3, 4), S(4, 2), S(-5, -2)};
const i32 king_attacks[] = {S(11, -6), S(19, -5), S(27, -10), S(21, 3), 0};
const i32 pawn_protection[] = {S(22, 13), S(2, 15), S(6, 17), S(7, 10), S(-5, 19), S(-29, 24)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 1), S(12, 5), S(10, 17), S(10, 16), S(5, 5)};
const i32 passers[] = {S(2, 14), S(32, 50), S(61, 123), S(195, 249)};
const i32 pawn_passed_protected = S(10, 19);
const i32 pawn_doubled_penalty = S(11, 36);
const i32 pawn_phalanx = S(12, 11);
const i32 pawn_passed_blocked_penalty[] = {S(9, 13), S(-6, 41), S(-8, 83), S(-9, 158)};
const i32 pawn_passed_king_distance[] = {S(1, -6), S(-3, 11)};
const i32 bishop_pair = S(32, 72);
const i32 king_shield[] = {S(37, -12), S(28, -7)};
