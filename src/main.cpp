...
const int pst_file[][8] = {
    {S(-4, 1), S(-3, 2), S(-2, 0), S(0, -1), S(3, -1), S(4, 0), S(6, 0), S(-4, -1)},
    {S(-13, -5), S(-5, -1), S(1, 3), S(5, 5), S(6, 5), S(6, 2), S(3, -2), S(-4, -7)},
    {S(-6, -3), S(-1, 0), S(1, 1), S(1, 2), S(1, 3), S(1, 2), S(5, -1), S(-2, -4)},
...
const int passers[] = {S(10, 14), S(37, 38), S(80, 92), S(283, 162)};
const int pawn_passed_protected = S(28, 16);
const int pawn_doubled = S(-19, -30);
const int pawn_phalanx = S(13, 12);
const int pawn_passed_blocked[] = {S(-10, -17), S(5, -42), S(10, -76), S(-15, -84)};
