...
const i32 max_material[] = {148, 520, 523, 952, 1782, 0, 0};
const i32 material[] = {S(89, 148), S(349, 520), S(361, 523), S(479, 952), S(1043, 1782), 0};
const i32 pst_rank[] = {
    ...
    S(0, -4),  S(-1, -3), S(-2, -2), S(-2, 1),  S(0, 2),  S(2, 2),  S(1, 4),  S(2, 1),    // Rook
...
const i32 pst_file[] = {
    ...
    S(-4, -3), S(-2, -1), S(0, 1),  S(2, 3),  S(2, 3),  S(2, 0),  S(1, -1), S(-1, -3),  // Knight
    ...
    S(-2, -5), S(3, -2),  S(-1, 1), S(-4, 2), S(-4, 3), S(-2, 2), S(2, -1), S(0, -5),   // King
};
...
const i32 pawn_protection[] = {S(23, 16), S(2, 17), S(6, 17), S(8, 9), S(-8, 22), S(-28, 24)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 0), S(12, 7), S(11, 19), S(9, 18), S(4, 10)};
const i32 passers[] = {S(1, 22), S(30, 73), S(64, 179), S(206, 285)};
const i32 pawn_passed_protected = S(11, 24);
const i32 pawn_doubled_penalty = S(11, 39);
const i32 pawn_phalanx = S(13, 16);
const i32 pawn_passed_blocked_penalty[] = {S(-13, 17), S(-32, 52), S(-54, 128), S(-83, 183)};
const i32 pawn_passed_king_distance[] = {S(-2, -6), S(-2, 10)};
const i32 bishop_pair = S(29, 84);
const i32 king_shield[] = {S(33, -10), S(24, -7)};
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    if (rank > 2 && !(0x101010101010101ull << sq & (pawns[1] | attacked_by_pawns))) {
                        ...
                        if (north(piece_bb) & pos.colour[1] || is_attacked(pos, sq + 8))
