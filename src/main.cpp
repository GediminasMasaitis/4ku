...
const i32 max_material[] = {141, 466, 470, 873, 1750, 0, 0};
const i32 material[] = {S(88, 141), S(308, 466), S(316, 470), S(411, 873), S(717, 1750), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3), 0,        0,          // Pawn
    S(-3, -4), S(-1, -2), S(0, -1),  S(2, 3),   S(3, 4),  S(6, 1), S(4, 0),  S(-12, 0),  // Knight
    ...
    S(-1, -5), S(1, -2),  0,         S(-3, 2),  S(0, 4),  S(5, 4), S(2, 3),  S(0, -3)    // King
};
const i32 pst_file[] = {
    ...
    S(-2, -4), S(-1, -2), S(-1, 0), S(0, 1),  S(0, 2),  S(0, 2),  S(2, 1),  S(1, 1),    // Queen
...
const i32 mobilities[] = {S(8, 5), S(7, 7), S(3, 5), S(3, 3), S(-4, -1)};
const i32 king_attacks[] = {S(11, -5), S(19, -4), S(27, -10), S(20, 6), 0};
const i32 pawn_protection[] = {S(21, 15), S(2, 15), S(6, 18), S(8, 9), S(-7, 21), S(-31, 23)};
const i32 pawn_threat_penalty[] = {S(-3, 0), S(21, 1), S(11, 5), S(11, 16), S(9, 14), S(5, 5)};
const i32 passers[] = {S(1, 14), S(28, 52), S(56, 131), S(166, 282)};
const i32 pawn_passed_protected = S(8, 19);
const i32 pawn_doubled_penalty = S(9, 37);
const i32 pawn_phalanx = S(11, 12);
const i32 pawn_passed_blocked_penalty[] = {S(7, 14), S(-8, 40), S(-9, 86), S(-33, 189)};
const i32 pawn_passed_king_distance[] = {S(1, -7), S(-4, 12)};
const i32 bishop_pair = S(29, 74);
