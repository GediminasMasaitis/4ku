...
const i32 max_material[] = {137, 443, 446, 839, 1700, 0, 0};
const i32 material[] = {S(92, 137), S(324, 443), S(334, 446), S(437, 839), S(740, 1700), 0};
const i32 pst_rank[] = {
...
const i32 king_attacks[] = {S(10, -5), S(19, -5), S(27, -10), S(20, 5), 0};
const i32 pawn_protection[] = {S(22, 14), S(2, 14), S(6, 17), S(8, 9), S(-5, 19), S(-30, 24)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 2), S(11, 6), S(10, 17), S(9, 16), S(5, 6)};
const i32 passers[] = {S(2, 14), S(32, 51), S(60, 125), S(194, 256)};
const i32 pawn_passed_protected = S(10, 18);
const i32 pawn_doubled_penalty = S(10, 36);
const i32 pawn_phalanx = S(12, 11);
const i32 pawn_passed_blocked_penalty[] = {S(8, 13), S(-7, 40), S(-8, 80), S(-9, 158)};
