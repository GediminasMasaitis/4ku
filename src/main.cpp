...
const i32 material[] = {S(81, 134), S(351, 522), S(363, 523), S(480, 956), S(1046, 1784), 0};
const i32 pst_rank[] = {
...
const i32 pawn_protection[] = {S(27, 25), S(1, 18), S(5, 18), S(7, 10), S(-9, 22), S(-30, 24)};
const i32 pawn_threat_penalty[] = {S(-5, -3), S(21, 0), S(11, 7), S(10, 20), S(9, 17), S(4, 8)};
const i32 passers[] = {S(10, 12), S(50, 47), S(96, 115), S(286, 197)};
...
[[nodiscard]] i32 eval(Position &pos) {
    ...
    for (i32 c = 0; c < 2; ++c) {
        ...
        // Pawn mobility
        score += mobilities[0] * count(protected_by_pawns & ~pos.pieces[0]);
