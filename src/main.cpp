...
const i32 max_material[] = {147, 521, 522, 957, 1783, 0, 0};
const i32 material[] = {S(89, 147), S(350, 521), S(362, 522), S(479, 957), S(1046, 1783), 0};
const i32 pst_rank[] = {
    ...
    S(3, -11), S(3, -8),  S(2, -4),  S(0, 2),   S(0, 5),  S(-1, 5), S(-4, 7), S(-2, 4),   // Queen
...
const i32 passers[] = {S(11, 12), S(47, 44), S(94, 111), S(287, 198)};
const i32 pawn_passed_protected = S(11, 14);
const i32 pawn_doubled_penalty = S(11, 38);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(5, 19), S(-5, 45), S(-8, 88), S(54, 87)};
