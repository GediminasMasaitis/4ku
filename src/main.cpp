...
const i32 max_material[] = {147, 517, 522, 956, 1770, 0, 0};
const i32 material[] = {S(89, 147), S(347, 517), S(362, 522), S(479, 956), S(1050, 1770), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-1, -5), S(1, -3),  S(2, -1),  S(3, 3),   S(3, 4),  S(5, 1),  S(2, 0),  S(-15, 1),  // Knight
    S(0, -2),  S(2, -1),  S(2, 0),   S(2, 0),   S(2, 1),  S(3, 0),  S(-1, 0), S(-10, 2),  // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-3, 1),  S(0, 2),  S(1, 2),  S(1, 3),  S(3, 1),    // Rook
    S(2, -11), S(3, -7),  S(2, -3),  S(0, 2),   S(-1, 4), S(-1, 4), S(-4, 7), S(-1, 4),   // Queen
    S(-1, -6), S(1, -2),  S(-1, 0),  S(-4, 3),  S(-1, 5), S(5, 4),  S(3, 2),  S(3, -5),   // King
};
const i32 pst_file[] = {
    S(-2, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
    S(-4, -3), S(-1, -1), S(0, 2),  S(2, 3),  S(2, 3),  S(2, 0),  S(1, -1), S(-1, -3),  // Knight
    S(-2, -1), 0,         S(1, 0),  S(0, 1),  S(1, 1),  S(0, 1),  S(1, 0),  S(-1, -1),  // Bishop
    S(-1, 0),  S(-1, 1),  S(0, 1),  S(1, 0),  S(2, -1), S(1, 0),  S(1, 0),  S(-2, -1),  // Rook
    S(-2, -2), S(-1, 0),  S(-1, 1), S(0, 1),  S(0, 2),  S(0, 2),  S(2, -1), S(1, -2),   // Queen
    S(-2, -5), S(3, -2),  S(-1, 1), S(-4, 2), S(-3, 2), S(-1, 1), S(2, -1), S(0, -5),   // King
};
...
const i32 king_attacks[] = {S(12, 0), S(11, -2), S(18, -6), S(9, 16), 0};
const i32 pawn_protection[] = {S(23, 16), S(2, 18), S(6, 19), S(8, 10), S(-8, 22), S(-29, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(22, 0), S(13, 6), S(10, 20), S(10, 20), S(5, 8)};
const i32 passers[] = {S(10, 12), S(47, 47), S(95, 116), S(285, 202)};
const i32 pawn_passed_protected = S(12, 23);
const i32 pawn_doubled_penalty = S(12, 38);
const i32 pawn_phalanx = S(13, 16);
const i32 pawn_passed_blocked_penalty[] = {S(7, 19), S(-7, 45), S(-10, 88), S(54, 88)};
