...
const i32 max_material[] = {136, 443, 445, 835, 1692, 0, 0};
const i32 material[] = {S(93, 136), S(324, 443), S(334, 445), S(439, 835), S(745, 1692), 0};
const i32 pst_rank[] = {
    ...
    S(0, -6),  S(1, -2),  0,         S(-3, 3),  S(-1, 5), S(3, 5), S(0, 4),  S(-2, -3)   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, -1), S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
...
const i32 pawn_protection[] = {S(22, 15), S(2, 14), S(6, 18), S(8, 10), S(-5, 19), S(-29, 21)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 2), S(11, 6), S(10, 17), S(9, 16), S(5, 4)};
const i32 passers[] = {S(-13, 40), S(58, 40), S(138, 85), S(321, 207)};
const i32 pawn_passed_protected = S(10, 15);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(12, 12);
const i32 pawn_passed_blocked_penalty[] = {S(-1, 36), S(-10, 50), S(-8, 76), S(-5, 137)};
const i32 pawn_passed_king_distance[] = {S(-5, -9), S(-7, 23)};
