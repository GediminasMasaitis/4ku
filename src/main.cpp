...
const i32 max_material[] = {137, 444, 447, 838, 1699, 0, 0};
const i32 material[] = {S(91, 137), S(318, 444), S(327, 447), S(430, 838), S(726, 1699), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 2), 0,        0,          // Pawn
    S(-2, -4), S(-1, -3), S(0, -1),  S(2, 2),   S(3, 3),  S(6, 1), S(4, 0),  S(-12, 1),  // Knight
    S(-1, -2), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 1),  S(2, 0), 0,        S(-8, 2),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-3, 0),  S(0, 2),  S(2, 2), S(1, 3),  S(3, 1),    // Rook
    S(2, -11), S(3, -8),  S(1, -4),  S(0, 1),   S(-1, 5), S(0, 5), S(-3, 6), S(-2, 5),   // Queen
    S(-1, -5), S(1, -2),  0,         S(-2, 2),  S(0, 4),  S(5, 4), S(2, 3),  S(1, -3)    // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
    S(-4, -3), S(-2, -1), S(0, 1),  S(2, 3),  S(2, 2),  S(2, 0),  S(1, 0),  S(-1, -3),  // Knight
...
const i32 mobilities[] = {S(8, 5), S(8, 7), S(3, 4), S(4, 2), S(-5, 0)};
const i32 king_attacks[] = {S(10, -4), S(19, -5), S(26, -9), S(20, 5), 0};
const i32 pawn_protection[] = {S(22, 14), S(2, 14), S(6, 17), S(8, 9), S(-6, 19), S(-31, 24)};
const i32 pawn_attacked[] = {S(58, 31), S(62, 46), S(54, 23), S(59, 15), 0};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(20, 2), S(11, 6), S(10, 17), S(9, 16), S(5, 5)};
const i32 passers[] = {S(3, 14), S(32, 51), S(61, 125), S(195, 255)};
const i32 pawn_passed_protected = S(9, 18);
const i32 pawn_doubled_penalty = S(10, 36);
const i32 pawn_phalanx = S(12, 12);
const i32 pawn_passed_blocked_penalty[] = {S(9, 13), S(-7, 40), S(-8, 82), S(-7, 160)};
