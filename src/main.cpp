...
const i32 material[] = {S(94, 139), S(334, 432), S(344, 435), S(457, 821), S(794, 1652), 0};
const i32 pst_rank[] = {
...
const i32 king_attacks[] = {S(10, -5), S(19, -5), S(27, -10), S(21, 4), 0};
const i32 pawn_protection[] = {S(22, 14), S(2, 14), S(6, 17), S(7, 10), S(-5, 19), S(-31, 25)};
const i32 pawn_threat_penalty[] = {S(-5, 0), S(21, 1), S(12, 5), S(11, 17), S(10, 17), S(6, 5)};
const i32 passers[] = {S(1, 14), S(30, 50), S(59, 122), S(193, 248)};
const i32 pawn_passed_protected = S(10, 18);
const i32 pawn_doubled_penalty[] = {S(15, 45), S(4, 28)};
const i32 pawn_phalanx = S(12, 12);
const i32 pawn_passed_blocked_penalty[] = {S(9, 12), S(-6, 40), S(-7, 81), S(-9, 156)};
...
[[nodiscard]] i32 eval(Position &pos) {
    ...
    for (i32 c = 0; c < 2; ++c) {
        ...
        // Doubled pawns
        score -= pawn_doubled_penalty[0] * count(north(pawns[0]) & pawns[0]);
        score -= pawn_doubled_penalty[1] * count(north(north(pawns[0])) & pawns[0]);
