...
const i32 max_material[] = {125, 408, 442, 768, 1471, 0, 0};
const i32 material[] = {S(107, 125), S(377, 408), S(390, 442), S(492, 768), S(974, 1471), 0};
const i32 pst_rank[][8] = {
    ...
    {S(-2, -8), S(0, -9), S(0, -5), S(-1, 2), S(-1, 6), S(3, 4), S(-1, 7), S(4, 4)},
    {S(0, -5), S(0, -1), S(-2, 0), S(-5, 2), S(-1, 3), S(6, 2), S(4, 1), S(2, -4)},
};
const i32 pst_file[][8] = {
    ...
    {S(-2, -3), S(1, -1), S(-4, 1), S(-4, 2), S(-5, 2), S(-1, 1), S(2, 0), S(2, -3)},
};
const i32 open_files[][3] = {
    {S(28, 18), S(6, 21), S(-25, 7)},
    {S(59, 10), S(-6, 38), S(-70, -3)},
};
const i32 pawn_protection[] = {S(26, 14), S(5, 16), S(2, 8), S(10, 5), S(-10, 12), S(-35, 23)};
const i32 passers[] = {S(-10, 15), S(15, 45), S(47, 108), S(198, 195)};
const i32 pawn_passed_protected = S(16, 18);
const i32 pawn_doubled = S(-16, -31);
const i32 pawn_phalanx = S(12, 13);
const i32 pawn_passed_blocked[] = {S(-8, -19), S(9, -43), S(11, -79), S(20, -102)};
const i32 pawn_passed_king_distance[] = {S(2, -6), S(-4, 10)};
const i32 bishop_pair = S(35, 65);
const i32 king_shield[][2] = {
    {S(42, -10), S(31, -9)},
    {S(50, -13), S(33, -5)},
};
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    if (p == King && piece_bb & 0xC3D7) {
                        ...
                        score += count(shield & pawns[0]) * king_shield[file < 3][0];
                        score += count(north(shield) & pawns[0]) * king_shield[file < 3][1];
                    }
                }
            }
        }
