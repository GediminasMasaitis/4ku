...
const i32 max_material[] = {147, 518, 525, 955, 1784, 0, 0};
const i32 material[] = {S(91, 147), S(344, 518), S(357, 525), S(480, 955), S(1047, 1784), 0};
const i32 pst_rank[] = {
    0,         S(-2, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-2, -6), S(0, -3),  S(1, -1),  S(3, 3),   S(4, 4),  S(5, 1),  S(3, 0),  S(-14, 2),  // Knight
    S(-1, -2), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 1),  S(2, 0),  S(-1, 0), S(-9, 2),   // Bishop
...
const i32 pawn_protection[] = {S(22, 16), S(1, 0), S(-1, 21), S(5, -5), S(-10, 24), S(-29, 25)};
const i32 pawn_threat_penalty[] = {S(12, -7), S(3, 10), S(9, 18), S(8, 17), S(3, 8)};
const i32 outposts[] = {S(18, 28), S(41, -16), S(15, 19), S(11, -10), 0};
const i32 passers[] = {S(6, 12), S(45, 47), S(94, 116), S(284, 201)};
const i32 pawn_passed_protected = S(17, 23);
        ...
        for (i32 p = Pawn; p < None; ++p) {
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    else if (piece_bb & protected_by_pawns)
                        score += outposts[p - 1];
