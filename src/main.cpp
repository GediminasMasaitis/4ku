...
const i32 max_material[] = {134, 522, 523, 956, 1783, 0, 0};
const i32 material[] = {S(81, 134), S(351, 522), S(363, 523), S(479, 956), S(1046, 1783), 0};
const i32 pst_rank[] = {
    0,         S(-3, -1), S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-2, -5), S(0, -3),  S(1, -1),  S(3, 3),   S(4, 4),  S(6, 1),  S(2, 0),  S(-15, 1),  // Knight
...
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, -1), S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
...
const i32 mobilities[] = {S(5, 8), S(8, 5), S(7, 7), S(3, 5), S(3, 2), S(-5, -1)};
const i32 king_attacks[] = {S(11, -5), S(19, -4), S(27, -9), S(18, 12), 0};
const i32 pawn_protection[] = {S(27, 25), S(7, 26), S(10, 26), S(13, 18), S(-3, 30), S(-25, 33)};
const i32 pawn_threat_penalty[] = {S(-5, -3), S(21, 0), S(11, 7), S(10, 20), S(9, 17), S(4, 8)};
const i32 passers[] = {S(10, 12), S(50, 47), S(96, 115), S(285, 197)};
const i32 pawn_passed_protected = S(13, 22);
const i32 pawn_doubled_penalty = S(12, 39);
const i32 pawn_phalanx = S(11, 15);
...
const i32 king_shield[] = {S(35, -9), S(24, -7)};
...
[[nodiscard]] i32 eval(Position &pos) {
    ...
    for (i32 c = 0; c < 2; ++c) {
        ...
        // Pawn mobility
        score += mobilities[0] * count(protected_by_pawns & ~pos.colour[0]);
        ...
        for (i32 p = Pawn; p < None; ++p) {
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    score += king_attacks[p] * count(mobility & king(kings[1], 0));
