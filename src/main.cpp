...
const i32 max_material[] = {147, 521, 523, 957, 1784, 0, 0};
const i32 material[] = {S(89, 147), S(349, 521), S(362, 523), S(480, 957), S(1045, 1784), 0};
const i32 pst_rank[] = {
    ...
    S(0, -6),  S(1, -2),  S(-1, 0),  S(-4, 3),  S(-2, 5), S(3, 4),  S(3, 2),  S(3, -5),   // King
};
const i32 pst_file[] = {
    S(-2, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, -1), S(-1, -1),  // Pawn
...
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 0), S(12, 7), S(10, 20), S(9, 17), S(4, 8)};
const i32 passers[] = {S(25, 3), S(86, 33), S(154, 97), S(360, 183)};
const i32 passer_files[] = {S(55, -11), S(31, 0), S(15, -2), S(7, -4), 0, S(8, -4), S(-33, 34), S(3, 19)};
const i32 pawn_passed_protected = S(16, 22);
const i32 pawn_doubled_penalty = S(11, 38);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(3, 19), S(-7, 44), S(-9, 88), S(57, 87)};
const i32 pawn_passed_king_distance[] = {S(-3, -6), S(-5, 12)};
