...
const i32 max_material[] = {134, 522, 523, 956, 1784, 0, 0};
const i32 material[] = {S(84, 134), S(351, 522), S(362, 523), S(480, 956), S(1046, 1784), 0};
const i32 pst_rank[] = {
...
const i32 mobilities[] = {S(4, 8), S(8, 5), S(7, 7), S(3, 5), S(3, 2), S(-5, -1)};
const i32 king_attacks[] = {S(11, -5), S(19, -4), S(27, -9), S(18, 12), 0};
const i32 pawn_protection[] = {S(25, 25), S(5, 26), S(9, 26), S(11, 18), S(-5, 30), S(-26, 33)};
const i32 pawn_threat_penalty[] = {S(-4, -2), S(21, 0), S(11, 7), S(10, 20), S(9, 17), S(4, 8)};
const i32 passers[] = {S(10, 12), S(49, 47), S(96, 115), S(286, 197)};
...
const i32 king_shield[] = {S(34, -9), S(24, -7)};
...
[[nodiscard]] i32 eval(Position &pos) {
    ...
    for (i32 c = 0; c < 2; ++c) {
        ...
        // Pawn mobility
        score += mobilities[0] * count(protected_by_pawns & ~pos.colour[0] & ~attacked_by_pawns);
