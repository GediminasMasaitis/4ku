...
const i32 max_material[] = {125, 407, 441, 766, 1467, 0, 0};
const i32 material[] = {S(106, 125), S(378, 407), S(391, 441), S(493, 766), S(976, 1467), 0};
const i32 pst_rank[][8] = {
    {0, S(-3, 0), S(-3, 0), S(-1, -1), S(2, -1), S(5, 2), 0, 0},
    {S(-6, -5), S(-4, -1), S(-1, 0), S(1, 3), S(5, 4), S(10, 1), S(6, -1), S(-11, -1)},
    {S(-5, -2), S(-1, -1), S(1, 0), S(2, 1), S(3, 2), S(6, 0), S(2, 0), S(-8, 0)},
    {S(-3, -2), S(-4, -3), S(-4, -2), S(-4, 0), S(0, 1), S(3, 1), S(5, 2), S(8, 1)},
    {S(-2, -8), S(0, -9), S(0, -5), S(-2, 2), S(-1, 6), S(3, 4), S(-1, 7), S(4, 4)},
    {S(0, -6), S(0, -2), S(-2, 0), S(-5, 3), S(-2, 4), S(5, 3), S(2, 2), S(0, -4)},
};
const i32 pst_file[][8] = {
    {S(-2, 1), S(-1, 1), S(-1, 0), S(1, -1), S(1, 0), S(2, 0), S(3, 0), S(-2, 0)},
    ...
    {S(-4, -4), S(-2, -2), S(-1, 0), S(0, 2), S(0, 3), S(1, 3), S(3, 0), S(2, -1)},
    {S(-1, -4), S(2, -1), S(-3, 1), S(-3, 2), S(-5, 2), S(-1, 1), S(2, 0), S(2, -4)},
};
const i32 open_files[][3] = {
    {S(29, 18), S(6, 21), S(-25, 9)},
    {S(59, 10), S(-6, 37), S(-69, -4)},
};
const i32 pawn_protection[] = {S(26, 14), S(4, 17), S(1, 8), S(9, 5), S(-10, 13), S(-34, 21)};
const i32 passers[] = {S(-18, 38), S(38, 40), S(109, 79), S(303, 152)};
const i32 pawn_passed_protected = S(16, 15);
const i32 pawn_doubled = S(-16, -31);
const i32 pawn_phalanx = S(12, 13);
const i32 pawn_passed_blocked[] = {S(1, -41), S(13, -52), S(9, -73), S(13, -82)};
const i32 pawn_passed_king_distance[] = {S(-2, -9), S(-8, 21)};
const i32 bishop_pair = S(35, 65);
const i32 king_shield[] = {S(46, -11), S(35, -10), S(10, -9)};
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    if (p == King && piece_bb & 0xC3D7) {
                        ...
                        score += count(north(north(shield)) & pawns[0]) * king_shield[2];
                    }
                }
            }
        }
