...
const i32 max_material[] = {136, 443, 446, 837, 1697, 0, 0};
const i32 material[] = {S(94, 136), S(325, 443), S(334, 446), S(439, 837), S(744, 1697), 0};
const i32 pst_rank[] = {
...
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(1, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
...
const i32 pawn_threat_penalty[] = {S(21, 2), S(11, 6), S(10, 18), S(9, 16), S(4, 6)};
const i32 passers[] = {S(0, 15), S(29, 51), S(60, 124), S(191, 255)};
const i32 pawn_passed_protected = S(11, 18);
const i32 pawn_doubled_penalty = S(9, 36);
const i32 pawn_phalanx = S(12, 11);
const i32 pawn_passed_blocked_penalty[] = {S(8, 13), S(-7, 40), S(-9, 82), S(-11, 160)};
