...
const i32 pst_rank[][8] = {
    ...
    {S(-4, -5), S(-2, -3), S(-1, -1), S(2, 3), S(3, 4), S(7, 1), S(5, 0), S(-11, 1)},
    {S(-2, -2), S(1, -2), S(1, 0), S(1, 0), S(2, 1), S(3, 0), S(1, 0), S(-8, 2)},
    {S(-1, -4), S(-2, -4), S(-3, -2), S(-3, 1), S(0, 2), S(3, 2), S(2, 4), S(4, 2)},
    {S(2, -12), S(2, -9), S(1, -4), S(-1, 1), S(-1, 6), S(0, 5), S(-2, 8), S(0, 6)},
    {S(-1, -5), S(1, -2), 0, S(-2, 3), S(0, 4), S(6, 4), S(4, 3), S(3, -4)},
};
...
const i32 open_files[][5] = {
    {S(3, 5), S(-4, 21), S(19, 16), S(4, 19), S(-21, 9)},
...
const i32 passers[] = {S(1, 15), S(31, 51), S(65, 125), S(214, 207)};
