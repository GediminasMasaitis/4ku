...
const i32 max_material[] = {147, 520, 522, 888, 1782, 0, 0};
const i32 material[] = {S(89, 147), S(349, 520), S(362, 522), S(434, 888), S(1046, 1782), 0};
const i32 pst_rank[] = {
...
const i32 rook_doubled = S(45, 68);
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    // Doubled rooks
                        ...
                        score += rook_doubled * count(file_bb & pos.colour[0] & pos.pieces[Rook]) - rook_doubled;
