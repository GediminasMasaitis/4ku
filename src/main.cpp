...
const i32 max_material[] = {151, 519, 526, 956, 1785, 0, 0};
const i32 material[] = {S(89, 151), S(343, 519), S(357, 526), S(480, 956), S(1047, 1785), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-2, -6), S(0, -3),  S(1, -1),  S(3, 3),   S(4, 4),  S(5, 1),  S(3, 0),  S(-14, 2),  // Knight
    S(-1, -1), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 1),  S(2, 0),  S(-1, 0), S(-9, 2),   // Bishop
    S(0, -4),  S(-1, -3), S(-2, -2), S(-2, 1),  S(0, 2),  S(2, 2),  S(1, 3),  S(2, 1),    // Rook
    S(2, -11), S(3, -8),  S(2, -4),  S(0, 2),   S(-1, 5), S(-1, 5), S(-4, 7), S(-2, 4),   // Queen
    S(-1, -6), S(1, -2),  S(-1, 0),  S(-4, 3),  S(-1, 5), S(4, 4),  S(5, 2),  S(5, -6),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
    S(-4, -3), S(-1, -1), S(0, 1),  S(2, 3),  S(2, 3),  S(2, 1),  S(1, 0),  S(-1, -3),  // Knight
    S(-2, -1), 0,         0,        S(0, 1),  S(1, 1),  S(0, 1),  S(2, 0),  S(0, -1),   // Bishop
...
const i32 king_attacks[] = {S(12, -6), S(18, -3), S(27, -9), S(18, 12), 0};
const i32 pawn_protection[] = {S(22, 21), S(1, 1), S(-1, 23), S(5, -4), S(-10, 25), S(-44, 21)};
const i32 pawn_threat_penalty[] = {S(-4, 6), S(12, -7), S(4, 10), S(10, 17), S(8, 17), S(4, 7)};
const i32 outposts[] = {S(2, -18), S(18, 25), S(40, -18), S(14, 18), S(11, -12), S(68, 2)};
const i32 passers[] = {S(8, 8), S(47, 43), S(94, 111), S(284, 199)};
const i32 pawn_passed_protected = S(15, 35);
const i32 pawn_doubled_penalty = S(11, 37);
const i32 pawn_phalanx = S(12, 17);
const i32 pawn_passed_blocked_penalty[] = {S(8, 19), S(-5, 44), S(-7, 87), S(54, 88)};
const i32 pawn_passed_king_distance[] = {S(-1, -6), S(-3, 12)};
const i32 bishop_pair = S(30, 84);
const i32 king_shield[] = {S(33, -10), S(25, -8)};
