...
const i32 max_material[] = {138, 439, 440, 831, 1647, 0, 0};
const i32 material[] = {S(95, 138), S(343, 439), S(352, 440), S(467, 831), S(849, 1647), 0};
const i32 pst_rank[] = {
...
const i32 passers[] = {S(2, 14), S(28, 48), S(59, 120), S(196, 246)};
const i32 pawn_passed_protected = S(10, 11);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(12, 11);
const i32 pawn_passed_blocked_penalty[] = {S(9, 13), S(-5, 41), S(-8, 84), S(-9, 158)};
