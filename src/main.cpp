...
const int open_files[][3] = {
    {S(31, 17), S(9, 14), S(-31, 10)},
    {S(64, 8), S(-11, 42), S(-84, 1)},
};
const int pawn_protection[] = {S(29, 13), S(6, 12), S(3, 6), S(11, 3), S(-10, 11), S(-30, 21)};
const int passers[] = {S(4, 11), S(40, 38), S(81, 95), S(270, 161)};
const int pawn_passed_protected = S(15, 19);
const int pawn_doubled = S(-18, -30);
const int pawn_phalanx = S(12, 12);
const int pawn_passed_blocked[] = {S(-8, -18), S(8, -42), S(13, -75), S(-12, -85)};
const int pawn_passed_king_distance[] = {S(0, -5), S(-4, 9)};
const int knight_outpost = S(19, -1);
const int bishop_pair = S(38, 62);
        ...
        for (int p = 0; p < 6; ++p) {
            ...
            while (copy) {
                ...
                if (p == Pawn) {
                    ...
                    if (p == Knight && !(0x101010101010101ULL << sq & attacked_by_pawns)) {
