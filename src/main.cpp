...
const i32 max_material[] = {140, 450, 452, 849, 1687, 0, 0};
const i32 material[] = {S(94, 140), S(340, 450), S(348, 452), S(461, 849), S(832, 1687), 0};
const i32 pst_rank[] = {
    ...
    S(2, -11), S(2, -9),  S(1, -4),  S(0, 1),   S(-1, 5), S(0, 5), S(-3, 7), S(-1, 5),   // Queen
...
const i32 pst_file[] = {
    ...
    S(-3, -5), S(2, -2),  S(-1, 1), S(-2, 1), S(-3, 2), S(-1, 1), S(2, -1), S(-1, -5)   // King
};
...
const i32 king_attacks[] = {S(11, -5), S(19, -5), S(28, -11), S(21, 3), 0};
const i32 pawn_protection[] = {S(22, 14), S(2, 15), S(6, 18), S(8, 9), S(-5, 19), S(-31, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 1), S(12, 5), S(11, 17), S(9, 17), S(6, 5)};
const i32 passers[] = {S(5, 14), S(36, 50), S(69, 123), S(222, 207)};
const i32 pawn_passed_protected = S(10, 20);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(12, 11);
const i32 pawn_passed_blocked_penalty[] = {S(9, 14), S(-7, 43), S(-9, 85), S(6, 97)};
